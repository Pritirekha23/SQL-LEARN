...
-- AND,OR,NOT
# a) Write a SQL query to display employee details those who are getting a salary greater than 25,000 and JDATE is 2022-10-22.
SELECT * FROM EMP_INFO WHERE (SAL>20000 AND JDATE='2019-10-22');
...
SELECT * FROM EMP_INFO WHERE (SAL>25000 AND JDATE>'2019-12-12') OR (SAL>300000);
